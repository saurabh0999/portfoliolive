        ...
        <>
         <div className="card ">
            ...
            <div className="d-flex justify-content-between">
                <h6 className="mb-2">Education Table</h6>
            </div>
            </div>
            ...
            <table className="table align-items-center ">
                <tbody>
                <tr>
                  <th><p className="text-xs font-weight-bold mb-0">Course</p></th>
                  <th><p className="text-xs font-weight-bold mb-0">College/School Name</p></th>
                ...
                <tr>
                    ...
                    <div className="d-flex px-2 py-1 align-items-center">
                        ...
                        <h6 className="text-sm mb-0">MBA</h6>
                        </div>
                    </div>
                    </td>
                    <td>
                    <div className="text-center">
                        <h6 className="text-sm mb-0">Jaipur technical University</h6>
                    </div>
                    </td>
                    <td>
                    <div className="text-center">
                        <h6 className="text-sm mb-0">June-2019</h6>
                    </div>
                    </td>
                    <td className="align-middle text-sm">
                    <div className="col text-center">
                        <h6 className="text-sm mb-0">July-2021</h6>
                    </div>
                    </td>
